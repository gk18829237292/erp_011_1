...
public class MainGuestActivity extends ActionBarActivity {
...
//        }
    ...
    private void selectItem(int position,int drawTag){
        ...
        switch (drawTag){
            ...
            case DrawerItem.DRAWER_ITEM_TAG_LEFT_MENUS:
                ...
                Intent intent= new Intent(MainGuestActivity.this,LoginActivity.class);
    ...
    public void commitFragment(Fragment fragment) {
        ...
        // navigation drawer
        mHandler.post(new MainGuestActivity.CommitFragmentRunnable(fragment));
    }
